<%-- 
    ...
    Created on : 28 Oct, 2020, 7:32:48 PM
    Author     : Vaidehi
--%>
    ...
    <head>
        ...
        <style>
            ...
            body {
                ...
                height: 100vh;
               background: url('images/adminbuilding.jpg') no-repeat ;
        ...
        <nav class="navbar navbar-inverse navbar-toggler navbar-fixed-top">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="AdminLoginPage.jsp"><span class="glyphicon glyphicon-user fa-spin"></span> ADMIN </a></li>
                    <li><a href="MemberLogin.html"><span class="glyphicon glyphicon-user "></span> USER </a></li>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <form>                 
                    ...
                    <br><br>
                    <input type="submit" class="fadeIn fourth" value="Log In" name="btnsub">
