                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Maintenance Start Date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <%
                                if (rs.getString("paid_status").equals("paid") && rs.getInt("rid") == u) {
                            %>

                            <td><input type="submit" id="pay" class="btn btn-primary" disabled value="pay" ></td>
                                <%
                                } else {
                                %>
                            <td><input type="submit" id="pay" class="btn btn-primary" value="pay" ></td>
                                <%
                                    }
                                %>
                        </tr>
...
<!--<a href="updateMember.jsp?mid=<%//=rs.getString("cid")%>">-->