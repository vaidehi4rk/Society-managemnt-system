<%-- 
    Document   : ViewMHistoryAdmin
    Created on : 29 Oct, 2020, 2:28:09 AM
    Author     : Vaidehi
--%>
    ...
    <body>
        ...
        <div id="page-content-wrapper">
            <div class="page-content text-center">
                ...
                <form method="post" target="mainHistory" action="ViewPaidHistory.jsp">
                    <button type="submit" class="btn btn-warning" name="paystatus" value="not paid" >Not Paid</button>

                    <button type="submit" class="btn btn-warning" name="paystatus" value="paid" >Paid</button>
                </form>
                <div><iframe height=680 width="1200" name="mainHistory" frameBorder="0"></iframe></div>
            </div>
            <br>
