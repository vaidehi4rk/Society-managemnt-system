<%-- 
    Document   : ViewNotices
    Created on : 29 Oct, 2020, 5:59:24 PM
    Author     : Vaidehi
--%>
...
<%
    ...
    Statement st = con.createStatement();
     ResultSet rs = st.executeQuery("select * from notices order by nid desc");%>
<!DOCTYPE html>
<html>
    <head>
                ...
                <tbody>
                    <%
                        while (rs.next()) {
                            ...
                            String noticedate = rs.getString("ndate");
                            String[] s = noticedate.split("-");
                            day = s[2];
                            month = s[1];
                            year = s[0];
