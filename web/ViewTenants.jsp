<%-- 
    ...
    Created on : 29 Oct, 2020, 12:02:26 PM
    Author     : Vaidehi
--%>
...
<%
    ...
    ResultSet rs = st.executeQuery("select * from memberregister m join tenant t on m.rid=t.rid");
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Tenant Joining Date</th>
                        <th scope="col">Tenant Aadhar no.</th>
                        <th scope="col">Tenant Contact no.</th>
                        <th scope="col">Tenant Emergency Contact no.</th>
                        <th scope="col">Tenant Gender</th>
                        <th scope="col">Tenant Old Address</th>
