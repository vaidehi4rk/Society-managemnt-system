...
<%
    ...
    ResultSet rs = st.executeQuery("select * from mastervote");
    ...
    <body>
        ...
        <div id="page-content-wrapper">
            <div class="page-content">
                <form action="nominationProcess.jsp" method="post">
                    <div class="row">
                        <div class="form-group ">
                            <label>Nominate your self</label>

                            <select id="nomination" name="nomination" class="form-control" oninvalid="this.setCustomValidity('Please Select your nomination')" oninput="setCustomValidity('')">
                                <%while (rs.next()) {
                                %>
                                <option name="nomination" value="<%=rs.getString("Category")%>"><%=rs.getString("Category")%></option>
                                <%
                                    }
                                %>
                            </select>
                    ...
                    <div>
                        <input type="submit" name="nstand" class="btn btn-warning">
                    </div>
